...
export const getFirebaseAnalytics = (): Analytics | null => analytics // Returns null if not initialized or not supported

export const isFirebaseConfigured = (): boolean =>
    !!(firebaseConfig.apiKey && firebaseConfig.databaseURL)

export const isAnalyticsDebugMode = (): boolean => ANALYTICS_DEBUG_MODE

export const isAnalyticsConsoleLogging = (): boolean => ANALYTICS_CONSOLE_LOGGING
