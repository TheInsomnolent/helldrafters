import { STRATAGEM_CODES, getStratagemIds, getRandomStratagem, KEY_TO_DIRECTION, DIRECTION_SYMBOLS } from './stratagemCodes';

describe('stratagemCodes', () => {
  describe('STRATAGEM_CODES', () => {
    it('should have valid structure for all stratagems', () => {
      Object.entries(STRATAGEM_CODES).forEach(([id, data]) => {
