...
export const ARMOR_PASSIVE_DESCRIPTIONS = {
    ...
    [ARMOR_PASSIVE.BALLISTIC_PADDING]:
    ...
    [ARMOR_PASSIVE.REINFORCED_EPAULETTES]:
    ...
    [ARMOR_PASSIVE.ADRENO_DEFIBRILLATOR]:
    ...
    [ARMOR_PASSIVE.REDUCED_SIGNATURE]:
