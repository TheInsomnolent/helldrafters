 ...
 */
import { WARBOND_TYPE, type Warbond } from '../types'

// Re-export WARBOND_TYPE for backwards compatibility
export { WARBOND_TYPE }

export const WARBONDS: Record<string, Warbond> = {
    // Standard (Free)
    HELLDIVERS_MOBILIZE: {
...
export const getWarbondById = (id: string): Warbond | undefined =>
    Object.values(WARBONDS).find((wb) => wb.id === id)

// Default warbond selections (just the free one)
export const DEFAULT_WARBONDS: string[] = [WARBONDS.HELLDIVERS_MOBILIZE.id]
