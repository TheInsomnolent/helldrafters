...
import type { DraftHandItem, Item, Loadout, Player } from './types'
import {
    trackDraftSelection,
    trackGameStart,
...
import { getMaxStarsForDifficulty } from './utils/dashboardHelper'
import {
    createDraftState,
    generateDraftHand,
    getDraftHandSize,
...
import { ArmorCombo, getArmorComboDisplayName } from './utils/itemHelpers'
...
function HelldiversRoguelikeApp() {
    ...
    const { importGameState, fileInputRef } = useGamePersistence({
        state,
        dispatch,
        firebaseReady,
        hostGame,
    ...
    return (
        <DashboardScreen
            ...
            startDraftPhase={startDraftPhase}
