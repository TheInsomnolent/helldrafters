...
import { COLORS, type FactionColorSet } from '../constants/theme'
import {
    getRandomStratagem,
    DIRECTION_SYMBOLS,
    KEY_TO_DIRECTION,
...
interface StratagemWithId extends StratagemCode {
    id: string
}

interface StratagemGameProps {
...
const StratagemGame = ({ factionColors }: StratagemGameProps): React.ReactElement | null => {
    const [currentStratagem, setCurrentStratagem] = useState<StratagemWithId | null>(null)
