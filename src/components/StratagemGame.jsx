...
import { getRandomStratagem, DIRECTION_SYMBOLS, KEY_TO_DIRECTION } from '../constants/stratagemCodes';
    ...
    <div style={{
      ...
      <div style={{ 
        ...
        <div style={{ textAlign: 'right' }}>
          <div style={{ fontSize: '12px', color: COLORS.TEXT_SECONDARY, fontWeight: 'bold' }}>
                ...
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: isFilled 
                      ? (isCorrectSoFar ? 'rgba(34, 197, 94, 0.2)' : 'rgba(239, 68, 68, 0.2)')
                      : COLORS.BG_MAIN,
                    border: `2px solid ${
                      isFilled
                        ? (isCorrectSoFar ? '#22c55e' : '#ef4444')
                        : COLORS.CARD_BORDER
                    }`,
                    borderRadius: '6px',
                    display: 'flex',
          ...
          {!result && userInput.length === 0 && (
            <div style={{
              ...
              <div style={{ marginBottom: '4px' }}>
                Use arrow keys: <span style={{ fontFamily: 'monospace', color: COLORS.TEXT_MUTED }}>▲ ▼ ◄ ►</span>
              </div>
              <div>
                or WASD keys • Press ESC to clear
              </div>
            </div>
          )}
        </div>
      ...
      {result === 'fail' && (
        <div style={{
          ...
          Correct code: {currentStratagem.code.map(dir => DIRECTION_SYMBOLS[dir]).join(' ')}
        </div>
      )}
    </div>
  );
