...
export default function RarityWeightDebug({ gameConfig }) {
    ...
    const subfactionMultiplier =
        SUBFACTION_CONFIG[gameConfig.subfaction]?.rareWeightMultiplier || 1.0
        ...
        >
            ...
            >
                <p style={{ margin: '0 0 4px 0' }}>
                    <strong>Player Count:</strong> {gameConfig.playerCount} (Rare Multiplier:{' '}
                    {Math.pow(0.7, gameConfig.playerCount - 1).toFixed(3)}×)
                </p>
                <p style={{ margin: '0' }}>
                    <strong>Subfaction:</strong> {subfactionName} (Rare Multiplier:{' '}
                    {subfactionMultiplier.toFixed(2)}×)
                </p>
            </div>
            ...
            <div style={{ marginTop: '20px' }}>
                ...
                >
                    <table style={{ width: '100%', fontSize: '11px', borderCollapse: 'collapse' }}>
                        <thead
                            style={{ position: 'sticky', top: 0, background: 'rgba(0, 0, 0, 0.9)' }}
                        >
                            <tr style={{ background: 'rgba(255, 255, 255, 0.1)' }}>
            ...
            >
                <strong>Note:</strong> Weights shown are base rarity weights before additional
                modifiers like faction synergy, AT requirements, or backpack restrictions are
                applied.
            </div>
        </div>
    )
