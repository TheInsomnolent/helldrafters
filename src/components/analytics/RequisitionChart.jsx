...
const transformToMissionData = (data, missionStars) => {
  ...
  const missionData = sortedMissions.map((mission, index) => {
    ...
    const spendEvents = sortedData.filter(d => 
      d.change < 0 && 
      ...
      <ResponsiveContainer width="100%" height={height}>
        <AreaChart data={missionData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
          ...
          <Area
            ...
            activeDot={{ r: 6, fill: COLORS.PRIMARY, stroke: COLORS.CARD_BG, strokeWidth: 2 }}
          />
        </AreaChart>
      </ResponsiveContainer>
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            {allSpendEvents.map((event, index) => (
              ...
              >
                <span style={{ color: COLORS.ACCENT_RED, fontSize: '12px', fontWeight: 'bold' }}>
