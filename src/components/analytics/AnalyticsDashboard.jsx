...
const AnalyticsDashboard = ({
    ...
    const chartData = analyticsData
        ? {
              samplesData:
                  analyticsData.sampleSnapshots?.map((s) => ({
                      time: s.timestamp,
                      common: s.common,
                      rare: s.rare,
              ...
              requisitionData:
                  analyticsData.requisitionSnapshots?.map((r) => ({
                      time: r.timestamp,
                      amount: r.amount,
                      change: r.change,
                      reason: r.reason,
              ...
              eventMarkers:
                  analyticsData.eventOccurrences?.map((e) => ({
                      time: e.timestamp,
                      name: e.eventName,
                      type: e.eventType,
    ...
    const subfactionName =
        subfaction && SUBFACTION_CONFIG[subfaction] ? SUBFACTION_CONFIG[subfaction].name : null
    ...
    const startingSubfactionName =
        startingSubfaction && SUBFACTION_CONFIG[startingSubfaction]
