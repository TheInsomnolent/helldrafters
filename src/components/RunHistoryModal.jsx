...
import { getRunSummaries, getRunById, deleteRunFromHistory, getRunHistoryStats } from '../systems/persistence/saveManager';
            ...
            <div style={{
              ...
              {runs.map((run) => {
                ...
                return (
                  ...
                  >
                    <div
                      onClick={() => setSelectedRun(selectedRun === run.runId ? null : run.runId)}
                      style={{
                        padding: '16px',
                        cursor: 'pointer',
                        display: 'flex',
                    ...
                    >
                      ...
                      <ChevronRight 
                        ...
                        style={{
                          color: COLORS.TEXT_MUTED,
                          transform: selectedRun === run.runId ? 'rotate(90deg)' : 'rotate(0)',
                      ...
                      <div style={{
                        ...
                        <div style={{
                          ...
                          {confirmDelete === run.runId ? (
                            ...
                            <button
                              onClick={() => setConfirmDelete(run.runId)}
                              style={{
                                ...BUTTON_STYLES.SECONDARY,
                                padding: '10px 16px',
                                borderRadius: '6px',
