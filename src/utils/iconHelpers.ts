 ...
 * @returns The wiki icon URL
 */
export const generateIconUrl = (name: string): string | null => {
    if (!name) return null
 ...
 */
export const CUSTOM_ICON_URLS: Record<string, string> = {
    ...
    p_censor: `${WIKI_BASE_URL}/R-72_Censor_Primary_Render.png`,
    p_suppressor: `${WIKI_BASE_URL}/AR-59_Suppressor_Primary_Render.png`,
    ...
    s_m6c: `${WIKI_BASE_URL}/M6C-SOCOM_Pistol_Secondary_Render.png`,
    ...
    s_warrant: `${WIKI_BASE_URL}/P-92_Warrant_Secondary_Render.png`,
    s_machete: `${WIKI_BASE_URL}/CQC-42_Machete_Secondary_Weaponry.png`,
    s_re_educator: `${WIKI_BASE_URL}/P-35_Re-Educator_Secondary_Render.png`,
    ...
    // Orbitals
    st_ops: `${WIKI_BASE_URL}/Orbital_Precision_Strike_Stratagem_Icon.svg`,
    st_gatling: `${WIKI_BASE_URL}/Orbital_Gatling_Barrage_Stratagem_Icon.svg`,
    st_airburst: `${WIKI_BASE_URL}/Orbital_Airburst_Strike_Stratagem_Icon.svg`,
    st_120: `${WIKI_BASE_URL}/Orbital_120mm_HE_Barrage_Stratagem_Icon.svg`,
    st_380: `${WIKI_BASE_URL}/Orbital_380mm_HE_Barrage_Stratagem_Icon.svg`,
    st_walking: `${WIKI_BASE_URL}/Orbital_Walking_Barrage_Stratagem_Icon.svg`,
    st_laser: `${WIKI_BASE_URL}/Orbital_Laser_Stratagem_Icon.svg`,
    st_railcannon: `${WIKI_BASE_URL}/Orbital_Railcannon_Strike_Stratagem_Icon.svg`,
    st_gas_o: `${WIKI_BASE_URL}/Orbital_Gas_Strike_Stratagem_Icon.svg`,
    st_ems_o: `${WIKI_BASE_URL}/Orbital_EMS_Strike_Stratagem_Icon.svg`,
    st_smoke_o: `${WIKI_BASE_URL}/Orbital_Smoke_Strike_Stratagem_Icon.svg`,
    st_napalm_o: `${WIKI_BASE_URL}/Orbital_Napalm_Barrage_Stratagem_Icon.svg`,

    // Eagles
    st_e_strafe: `${WIKI_BASE_URL}/Eagle_Strafing_Run_Stratagem_Icon.svg`,
    st_e_airstrike: `${WIKI_BASE_URL}/Eagle_Airstrike_Stratagem_Icon.svg`,
    st_e_cluster: `${WIKI_BASE_URL}/Eagle_Cluster_Bomb_Stratagem_Icon.svg`,
    st_e_smoke: `${WIKI_BASE_URL}/Eagle_Smoke_Strike_Stratagem_Icon.svg`,
    st_e_rockets: `${WIKI_BASE_URL}/Eagle_110mm_Rocket_Pods_Stratagem_Icon.svg`,
    st_e_500: `${WIKI_BASE_URL}/Eagle_500kg_Bomb_Stratagem_Icon.svg`,
    st_e_napalm: `${WIKI_BASE_URL}/Eagle_Napalm_Airstrike_Stratagem_Icon.svg`,
    ...
    st_c4: `${WIKI_BASE_URL}/B_MD_C4_Pack_Stratagem_Icon.svg`,
    ...
    // Backpacks
    st_bp_jump: `${WIKI_BASE_URL}/Jump_Pack_Stratagem_Icon.svg`,
    st_bp_supply: `${WIKI_BASE_URL}/Supply_Pack_Stratagem_Icon.svg`,
    st_bp_dog: `${WIKI_BASE_URL}/Guard_Dog_Stratagem_Icon.png`,
    st_bp_shield: `${WIKI_BASE_URL}/Shield_Generator_Pack_Stratagem_Icon.svg`,
    st_bp_ballistic: `${WIKI_BASE_URL}/Ballistic_Shield_Backpack_Stratagem_Icon.svg`,
    ...
    st_bp_directional: `${WIKI_BASE_URL}/SH-51_Directional_Shield_Stratagem_Icon.svg`,
    st_bp_hellbomb: `${WIKI_BASE_URL}/Portable_Hellbomb_Stratagem_Icon.svg`,
    st_bp_hover: `${WIKI_BASE_URL}/Hover_Pack_Stratagem_Icon.svg`,
    st_bp_k9: `${WIKI_BASE_URL}/AX_ARC-3_%22Guard_Dog%22_K-9_Stratagem_Icon.png`,
    st_bp_warp: `${WIKI_BASE_URL}/LIFT-182_Warp_Pack_Stratagem_Icon.svg`,
    st_bp_hotdog: `${WIKI_BASE_URL}/AX_FLAM-75_%E2%80%9CGuard_Dog%E2%80%9D_Hot_Dog_Stratagem_Icon.png`,

    // Sentries and Emplacements
    st_s_mg: `${WIKI_BASE_URL}/Machine_Gun_Sentry_Stratagem_Icon.svg`,
    st_s_gat: `${WIKI_BASE_URL}/Gatling_Sentry_Stratagem_Icon.svg`,
    st_s_mortar: `${WIKI_BASE_URL}/Mortar_Sentry_Stratagem_Icon.svg`,
    st_s_ems: `${WIKI_BASE_URL}/AM-23_EMS_Mortar_Sentry_Stratagem_Icon.svg`,
    st_s_ac: `${WIKI_BASE_URL}/Autocannon_Sentry_Stratagem_Icon.svg`,
    st_s_rocket: `${WIKI_BASE_URL}/Rocket_Sentry_Stratagem_Icon.svg`,
    st_s_tesla: `${WIKI_BASE_URL}/Tesla_Tower_Stratagem_Icon.svg`,
    st_s_mines: `${WIKI_BASE_URL}/Anti-Personnel_Minefield_Stratagem_Icon.svg`,
    st_s_inc_mines: `${WIKI_BASE_URL}/Incendiary_Mines_Stratagem_Icon.svg`,
    st_s_at_mines: `${WIKI_BASE_URL}/MD-17_Anti-Tank_Mines_Stratagem_Icon.svg`,
    st_s_flame: `${WIKI_BASE_URL}/A_FLAM-40_Flame_Sentry_Stratagem_Icon.svg`,
    st_s_at_emp: `${WIKI_BASE_URL}/E_AT-12_Anti-Tank_Emplacement_Stratagem_Icon.svg`,
    st_s_laser: `${WIKI_BASE_URL}/A_LAS-98_Laser_Sentry_Stratagem_Icon.svg`,
    st_s_hmg: `${WIKI_BASE_URL}/HMG_Emplacement_Stratagem_Icon.svg`,
    st_s_shield_relay: `${WIKI_BASE_URL}/Shield_Generator_Relay_Stratagem_Icon.svg`,
    st_s_grenadier: `${WIKI_BASE_URL}/GL-21_Grenadier_Battlement_Stratagem_Icon.svg`,
    st_s_gas_mines: `${WIKI_BASE_URL}/Gas_Minefield_Stratagem_Icon.svg`,
 ...
 * @param item - The item object with id and name
 * @returns The icon URL or null
 */
export const getItemIconUrl = (item: Item | null | undefined): string | null => {
    if (!item) return null
