...
export const HELLDIVERS_MOBILIZE_ITEMS = [
  ...
  { id: 'p_constitution', name: 'R-2124 Constitution', type: TYPE.PRIMARY, rarity: RARITY.LEGENDARY, tags: [], warbond: 'helldivers_mobilize' },
  { id: 'p_punisher', name: 'SG-8 Punisher', type: TYPE.PRIMARY, rarity: RARITY.COMMON, tags: [TAGS.STUN], warbond: 'helldivers_mobilize' },
  { id: 'p_breaker', name: 'SG-225 Breaker', type: TYPE.PRIMARY, rarity: RARITY.COMMON, tags: [], warbond: 'helldivers_mobilize' },
  ...
  { id: 'p_slugger', name: 'SG-8S Slugger', type: TYPE.PRIMARY, rarity: RARITY.COMMON, tags: [TAGS.PRECISION], warbond: 'helldivers_mobilize' },
  ...
  { id: 'g_smoke', name: 'G-3 Smoke', type: TYPE.GRENADE, rarity: RARITY.COMMON, tags: [TAGS.SMOKE], warbond: 'helldivers_mobilize' },
  ...
  { id: 'a_cm09', name: 'CM-09 Bonesnapper', type: TYPE.ARMOR, rarity: RARITY.UNCOMMON, tags: [], warbond: 'helldivers_mobilize', passive: ARMOR_PASSIVE.MED_KIT, armorClass: ARMOR_CLASS.MEDIUM },
  { id: 'a_fs23', name: 'FS-23 Battle Master', type: TYPE.ARMOR, rarity: RARITY.COMMON, tags: [TAGS.DEFENSIVE], warbond: 'helldivers_mobilize', passive: ARMOR_PASSIVE.FORTIFIED, armorClass: ARMOR_CLASS.HEAVY },
  ...
  { id: 'a_sa04', name: 'SA-04 Combat Technician', type: TYPE.ARMOR, rarity: RARITY.COMMON, tags: [], warbond: 'helldivers_mobilize', passive: ARMOR_PASSIVE.SCOUT, armorClass: ARMOR_CLASS.MEDIUM },
  ...
  // BOOSTERS
  { id: 'b_space', name: 'Hellpod Space Optimization', type: TYPE.BOOSTER, rarity: RARITY.LEGENDARY, tags: [], warbond: 'helldivers_mobilize' },
  { id: 'b_stamina', name: 'Stamina Enhancement', type: TYPE.BOOSTER, rarity: RARITY.LEGENDARY, tags: [], warbond: 'helldivers_mobilize' },
  { id: 'b_muscle', name: 'Muscle Enhancement', type: TYPE.BOOSTER, rarity: RARITY.RARE, tags: [], warbond: 'helldivers_mobilize' },
  { id: 'b_reinforce', name: 'Reinforcement Budget', type: TYPE.BOOSTER, rarity: RARITY.RARE, tags: [], warbond: 'helldivers_mobilize' },
  { id: 'b_vitality', name: 'Vitality Enhancement', type: TYPE.BOOSTER, rarity: RARITY.LEGENDARY, tags: [], warbond: 'helldivers_mobilize' },
  { id: 'b_uav', name: 'UAV Recon', type: TYPE.BOOSTER, rarity: RARITY.RARE, tags: [], warbond: 'helldivers_mobilize' },
  ...
  { id: 'st_380', name: 'Orbital 380mm HE Barrage', type: TYPE.STRATAGEM, rarity: RARITY.UNCOMMON, tags: [TAGS.EXPLOSIVE, TAGS.AT], warbond: 'helldivers_mobilize' },
  { id: 'st_walking', name: 'Orbital Walking Barrage', type: TYPE.STRATAGEM, rarity: RARITY.RARE, tags: [TAGS.EXPLOSIVE], warbond: 'helldivers_mobilize' },
  { id: 'st_laser', name: 'Orbital Laser', type: TYPE.STRATAGEM, rarity: RARITY.LEGENDARY, tags: [TAGS.AT, TAGS.FIRE], warbond: 'helldivers_mobilize' },
  ...
  { id: 'st_ems_o', name: 'Orbital EMS Strike', type: TYPE.STRATAGEM, rarity: RARITY.COMMON, tags: [TAGS.STUN], warbond: 'helldivers_mobilize' },
  ...
  { id: 'st_e_airstrike', name: 'Eagle Airstrike', type: TYPE.STRATAGEM, rarity: RARITY.COMMON, tags: [TAGS.EXPLOSIVE, TAGS.AT], warbond: 'helldivers_mobilize' },
  { id: 'st_e_cluster', name: 'Eagle Cluster Bomb', type: TYPE.STRATAGEM, rarity: RARITY.COMMON, tags: [], warbond: 'helldivers_mobilize' },
  ...
  { id: 'st_stalwart', name: 'Stalwart', type: TYPE.STRATAGEM, rarity: RARITY.UNCOMMON, tags: [TAGS.SUPPORT_WEAPON], warbond: 'helldivers_mobilize' },
  { id: 'st_eat', name: 'EAT-17 Expendable Anti-Tank', type: TYPE.STRATAGEM, rarity: RARITY.RARE, tags: [TAGS.SUPPORT_WEAPON, TAGS.AT], warbond: 'helldivers_mobilize' },
  { id: 'st_rr', name: 'Recoilless Rifle', type: TYPE.STRATAGEM, rarity: RARITY.RARE, tags: [TAGS.SUPPORT_WEAPON, TAGS.AT, TAGS.BACKPACK], warbond: 'helldivers_mobilize' },
  { id: 'st_flame', name: 'Flamethrower', type: TYPE.STRATAGEM, rarity: RARITY.COMMON, tags: [TAGS.SUPPORT_WEAPON, TAGS.FIRE], warbond: 'helldivers_mobilize' },
  { id: 'st_ac', name: 'Autocannon AC-8', type: TYPE.STRATAGEM, rarity: RARITY.RARE, tags: [TAGS.SUPPORT_WEAPON, TAGS.EXPLOSIVE, TAGS.BACKPACK], warbond: 'helldivers_mobilize' },
  ...
  { id: 'st_laser_can', name: 'Laser Cannon', type: TYPE.STRATAGEM, rarity: RARITY.COMMON, tags: [TAGS.SUPPORT_WEAPON], warbond: 'helldivers_mobilize' },
  { id: 'st_arc', name: 'Arc Thrower', type: TYPE.STRATAGEM, rarity: RARITY.COMMON, tags: [TAGS.SUPPORT_WEAPON], warbond: 'helldivers_mobilize' },
  ...
  { id: 'st_bp_dog', name: 'Guard Dog', type: TYPE.STRATAGEM, rarity: RARITY.UNCOMMON, tags: [TAGS.BACKPACK], warbond: 'helldivers_mobilize' },
  ...
  { id: 'st_bp_ballistic', name: 'Ballistic Shield', type: TYPE.STRATAGEM, rarity: RARITY.COMMON, tags: [TAGS.BACKPACK, TAGS.DEFENSIVE], warbond: 'helldivers_mobilize' },
...
export const STEELED_VETERANS_ITEMS = [
  { id: 'p_lib_con', name: 'AR-23C Liberator Concussive', type: TYPE.PRIMARY, rarity: RARITY.COMMON, tags: [TAGS.STUN], warbond: 'steeled_veterans' },
  ...
  { id: 'p_dominator', name: 'JAR-5 Dominator', type: TYPE.PRIMARY, rarity: RARITY.COMMON, tags: [TAGS.PRECISION], warbond: 'steeled_veterans' },
  { id: 's_senator', name: 'P-4 Senator', type: TYPE.SECONDARY, rarity: RARITY.RARE, tags: [TAGS.PRECISION], warbond: 'steeled_veterans' },
  { id: 'g_inc', name: 'G-10 Incendiary', type: TYPE.GRENADE, rarity: RARITY.UNCOMMON, tags: [TAGS.FIRE], warbond: 'steeled_veterans' },
  { id: 'b_flex_reinforce', name: 'Flexible Reinforcement Budget', type: TYPE.BOOSTER, rarity: RARITY.RARE, tags: [], warbond: 'steeled_veterans' },
  ...
  { id: 'a_sa32', name: 'SA-32 Dynamo', type: TYPE.ARMOR, rarity: RARITY.UNCOMMON, tags: [], warbond: 'steeled_veterans', passive: ARMOR_PASSIVE.SERVO_ASSISTED, armorClass: ARMOR_CLASS.HEAVY },
];
...
export const CUTTING_EDGE_ITEMS = [
  { id: 'p_sickle', name: 'LAS-16 Sickle', type: TYPE.PRIMARY, rarity: RARITY.UNCOMMON, tags: [], warbond: 'cutting_edge' },
  { id: 'p_blitzer', name: 'ARC-12 Blitzer', type: TYPE.PRIMARY, rarity: RARITY.UNCOMMON, tags: [TAGS.STUN], warbond: 'cutting_edge' },
  ...
  { id: 's_dagger', name: 'LAS-7 Dagger', type: TYPE.SECONDARY, rarity: RARITY.UNCOMMON, tags: [], warbond: 'cutting_edge' },
  { id: 'g_stun', name: 'G-23 Stun', type: TYPE.GRENADE, rarity: RARITY.UNCOMMON, tags: [TAGS.STUN], warbond: 'cutting_edge' },
  { id: 'b_local', name: 'Localization Confusion', type: TYPE.BOOSTER, rarity: RARITY.LEGENDARY, tags: [], warbond: 'cutting_edge' },
  { id: 'a_ex03', name: 'EX-03 Prototype 3', type: TYPE.ARMOR, rarity: RARITY.UNCOMMON, tags: [], warbond: 'cutting_edge', passive: ARMOR_PASSIVE.ELECTRICAL_CONDUIT, armorClass: ARMOR_CLASS.MEDIUM },
  ...
  { id: 'a_ex00', name: 'EX-00 Prototype X', type: TYPE.ARMOR, rarity: RARITY.UNCOMMON, tags: [], warbond: 'cutting_edge', passive: ARMOR_PASSIVE.ELECTRICAL_CONDUIT, armorClass: ARMOR_CLASS.LIGHT },
];
...
export const DEMOCRATIC_DETONATION_ITEMS = [
  { id: 'p_xbow', name: 'CB-9 Explosive Crossbow', type: TYPE.PRIMARY, rarity: RARITY.LEGENDARY, tags: [TAGS.EXPLOSIVE], warbond: 'democratic_detonation' },
  { id: 'p_eruptor', name: 'R-36 Eruptor', type: TYPE.PRIMARY, rarity: RARITY.LEGENDARY, tags: [TAGS.EXPLOSIVE], warbond: 'democratic_detonation' },
  { id: 's_grenapistol', name: 'GP-31 Grenade Pistol', type: TYPE.SECONDARY, rarity: RARITY.RARE, tags: [TAGS.EXPLOSIVE], warbond: 'democratic_detonation' },
  { id: 'g_thermite', name: 'Thermite Grenade', type: TYPE.GRENADE, rarity: RARITY.LEGENDARY, tags: [TAGS.AT, TAGS.FIRE], warbond: 'democratic_detonation' },
  ...
  { id: 'b_expert_pilot', name: 'Expert Extraction Pilot', type: TYPE.BOOSTER, rarity: RARITY.RARE, tags: [], warbond: 'democratic_detonation' },
  { id: 'a_ce27', name: 'CE-27 Ground Breaker', type: TYPE.ARMOR, rarity: RARITY.RARE, tags: [], warbond: 'democratic_detonation', passive: ARMOR_PASSIVE.ENGINEERING_KIT, armorClass: ARMOR_CLASS.MEDIUM },
  { id: 'a_ce07', name: 'CE-07 Demolition Specialist', type: TYPE.ARMOR, rarity: RARITY.RARE, tags: [], warbond: 'democratic_detonation', passive: ARMOR_PASSIVE.ENGINEERING_KIT, armorClass: ARMOR_CLASS.LIGHT },
  { id: 'a_fs55', name: 'FS-55 Devastator', type: TYPE.ARMOR, rarity: RARITY.COMMON, tags: [TAGS.DEFENSIVE], warbond: 'democratic_detonation', passive: ARMOR_PASSIVE.FORTIFIED, armorClass: ARMOR_CLASS.HEAVY },
];
...
export const POLAR_PATRIOTS_ITEMS = [
  { id: 'p_purifier', name: 'PLAS-101 Purifier', type: TYPE.PRIMARY, rarity: RARITY.LEGENDARY, tags: [TAGS.EXPLOSIVE], warbond: 'polar_patriots' },
  { id: 'p_pummeler', name: 'SMG-72 Pummeler', type: TYPE.PRIMARY, rarity: RARITY.UNCOMMON, tags: [TAGS.STUN], warbond: 'polar_patriots' },
  { id: 'p_tenderizer', name: 'AR-61 Tenderizer', type: TYPE.PRIMARY, rarity: RARITY.RARE, tags: [TAGS.PRECISION], warbond: 'polar_patriots' },
  { id: 's_verdict', name: 'P-113 Verdict', type: TYPE.SECONDARY, rarity: RARITY.UNCOMMON, tags: [], warbond: 'polar_patriots' },
  { id: 'g_inc_imp', name: 'G-13 Incendiary Impact', type: TYPE.GRENADE, rarity: RARITY.UNCOMMON, tags: [TAGS.FIRE], warbond: 'polar_patriots' },
  { id: 'b_shock', name: 'Motivational Shocks', type: TYPE.BOOSTER, rarity: RARITY.RARE, tags: [], warbond: 'polar_patriots' },
  ...
  { id: 'a_cw22', name: 'CW-22 Kodiak', type: TYPE.ARMOR, rarity: RARITY.COMMON, tags: [TAGS.DEFENSIVE], warbond: 'polar_patriots', passive: ARMOR_PASSIVE.FORTIFIED, armorClass: ARMOR_CLASS.HEAVY },
  { id: 'a_cw4', name: 'CW-4 Arctic Ranger', type: TYPE.ARMOR, rarity: RARITY.COMMON, tags: [], warbond: 'polar_patriots', passive: ARMOR_PASSIVE.SCOUT, armorClass: ARMOR_CLASS.LIGHT },
];
...
export const VIPER_COMMANDOS_ITEMS = [
  ...
  { id: 'a_ph9', name: 'PH-9 Predator', type: TYPE.ARMOR, rarity: RARITY.RARE, tags: [], warbond: 'viper_commandos', passive: ARMOR_PASSIVE.PEAK_PHYSIQUE, armorClass: ARMOR_CLASS.LIGHT },
  { id: 'a_ph202', name: 'PH-202 Twigsnapper', type: TYPE.ARMOR, rarity: RARITY.RARE, tags: [], warbond: 'viper_commandos', passive: ARMOR_PASSIVE.PEAK_PHYSIQUE, armorClass: ARMOR_CLASS.HEAVY },
  { id: 'b_infusion', name: 'Experimental Infusion', type: TYPE.BOOSTER, rarity: RARITY.LEGENDARY, tags: [], warbond: 'viper_commandos' },
];
...
export const FREEDOMS_FLAME_ITEMS = [
  { id: 'p_cookout', name: 'SG-451 Cookout', type: TYPE.PRIMARY, rarity: RARITY.LEGENDARY, tags: [TAGS.FIRE, TAGS.STUN], warbond: 'freedoms_flame' },
  { id: 'p_torcher', name: 'FLAM-66 Torcher', type: TYPE.PRIMARY, rarity: RARITY.RARE, tags: [TAGS.FIRE], warbond: 'freedoms_flame' },
  { id: 's_crisper', name: 'Crisper', type: TYPE.SECONDARY, rarity: RARITY.UNCOMMON, tags: [TAGS.FIRE], warbond: 'freedoms_flame' },
  { id: 'a_i09', name: 'I-09 Heatseeker', type: TYPE.ARMOR, rarity: RARITY.LEGENDARY, tags: [TAGS.FIRE], warbond: 'freedoms_flame', passive: ARMOR_PASSIVE.INFLAMMABLE, armorClass: ARMOR_CLASS.LIGHT },
  { id: 'a_i102', name: 'I-102 Draconaught', type: TYPE.ARMOR, rarity: RARITY.LEGENDARY, tags: [TAGS.FIRE], warbond: 'freedoms_flame', passive: ARMOR_PASSIVE.INFLAMMABLE, armorClass: ARMOR_CLASS.MEDIUM },
  { id: 'b_firepod', name: 'Firebomb Hellpods', type: TYPE.BOOSTER, rarity: RARITY.RARE, tags: [TAGS.FIRE], warbond: 'freedoms_flame' },
];
...
export const CHEMICAL_AGENTS_ITEMS = [
  { id: 'g_gas', name: 'Gas Grenade', type: TYPE.GRENADE, rarity: RARITY.LEGENDARY, tags: [], warbond: 'chemical_agents' },
  { id: 's_stimpistol', name: 'P-43 Stim Pistol', type: TYPE.SECONDARY, rarity: RARITY.UNCOMMON, tags: [TAGS.DEFENSIVE], warbond: 'chemical_agents' },
  ...
  { id: 'st_bp_dog_breath', name: 'AX/TX-13 "Guard Dog" Dog Breath', type: TYPE.STRATAGEM, rarity: RARITY.RARE, tags: [TAGS.BACKPACK], warbond: 'chemical_agents' },
  { id: 'a_af50', name: 'AF-50 Noxious Ranger', type: TYPE.ARMOR, rarity: RARITY.RARE, tags: [], warbond: 'chemical_agents', passive: ARMOR_PASSIVE.ADVANCED_FILTRATION, armorClass: ARMOR_CLASS.LIGHT },
  { id: 'a_af02', name: 'AF-02 Haz-Master', type: TYPE.ARMOR, rarity: RARITY.RARE, tags: [], warbond: 'chemical_agents', passive: ARMOR_PASSIVE.ADVANCED_FILTRATION, armorClass: ARMOR_CLASS.MEDIUM },
];
...
export const TRUTH_ENFORCERS_ITEMS = [
  { id: 'b_dead_sprint', name: 'Dead Sprint', type: TYPE.BOOSTER, rarity: RARITY.RARE, tags: [], warbond: 'truth_enforcers' },
  { id: 'p_halt', name: 'SG-20 Halt', type: TYPE.PRIMARY, rarity: RARITY.UNCOMMON, tags: [TAGS.STUN], warbond: 'truth_enforcers' },
  { id: 'p_reprimand', name: 'SMG-32 Reprimand', type: TYPE.PRIMARY, rarity: RARITY.RARE, tags: [], warbond: 'truth_enforcers' },
  { id: 's_loyalist', name: 'PLAS-15 Loyalist', type: TYPE.SECONDARY, rarity: RARITY.RARE, tags: [], warbond: 'truth_enforcers' },
  { id: 'a_uf50', name: 'UF-50 Bloodhound', type: TYPE.ARMOR, rarity: RARITY.RARE, tags: [], warbond: 'truth_enforcers', passive: ARMOR_PASSIVE.UNFLINCHING, armorClass: ARMOR_CLASS.MEDIUM },
  { id: 'a_uf16', name: 'UF-16 Inspector', type: TYPE.ARMOR, rarity: RARITY.RARE, tags: [], warbond: 'truth_enforcers', passive: ARMOR_PASSIVE.UNFLINCHING, armorClass: ARMOR_CLASS.LIGHT },
];
...
export const URBAN_LEGENDS_ITEMS = [
  { id: 'b_armed_pods', name: 'Armed Resupply Pods', type: TYPE.BOOSTER, rarity: RARITY.RARE, tags: [], warbond: 'urban_legends' },
  ...
  { id: 'st_s_at_emp', name: 'E/AT-12 Anti-Tank Emplacement', type: TYPE.STRATAGEM, rarity: RARITY.RARE, tags: [TAGS.DEFENSIVE, TAGS.AT], warbond: 'urban_legends' },
  { id: 'a_sr24', name: 'SR-24 Street Scout', type: TYPE.ARMOR, rarity: RARITY.LEGENDARY, tags: [], warbond: 'urban_legends', passive: ARMOR_PASSIVE.SIEGE_READY, armorClass: ARMOR_CLASS.LIGHT },
  { id: 'a_sr18', name: 'SR-18 Roadblock', type: TYPE.ARMOR, rarity: RARITY.LEGENDARY, tags: [TAGS.DEFENSIVE], warbond: 'urban_legends', passive: ARMOR_PASSIVE.SIEGE_READY, armorClass: ARMOR_CLASS.HEAVY },
];
...
export const SERVANTS_OF_FREEDOM_ITEMS = [
  { id: 'p_double_edge', name: 'LAS-17 Double-Edge Sickle', type: TYPE.PRIMARY, rarity: RARITY.RARE, tags: [], warbond: 'servants_of_freedom' },
  { id: 's_ultimatum', name: 'GP-20 Ultimatum', type: TYPE.SECONDARY, rarity: RARITY.LEGENDARY, tags: [TAGS.EXPLOSIVE], warbond: 'servants_of_freedom' },
...
export const BORDERLINE_JUSTICE_ITEMS = [
  { id: 'p_deadeye', name: 'R-6 Deadeye', type: TYPE.PRIMARY, rarity: RARITY.RARE, tags: [TAGS.PRECISION], warbond: 'borderline_justice' },
  { id: 's_talon', name: 'LAS-58 Talon', type: TYPE.SECONDARY, rarity: RARITY.LEGENDARY, tags: [TAGS.PRECISION], warbond: 'borderline_justice' },
  ...
  { id: 'b_sample_extricator', name: 'Sample Extricator', type: TYPE.BOOSTER, rarity: RARITY.RARE, tags: [], warbond: 'borderline_justice' },
...
export const MASTERS_OF_CEREMONY_ITEMS = [
  ...
  { id: 'b_sample_scanner', name: 'Sample Scanner', type: TYPE.BOOSTER, rarity: RARITY.RARE, tags: [], warbond: 'masters_of_ceremony' },
  ...
  { id: 'st_flag', name: 'CQC-1 One True Flag', type: TYPE.STRATAGEM, rarity: RARITY.LEGENDARY, tags: [TAGS.SUPPORT_WEAPON], warbond: 'masters_of_ceremony' },
];
...
export const FORCE_OF_LAW_ITEMS = [
  { id: 'p_pacifier', name: 'AR-32 Pacifier', type: TYPE.PRIMARY, rarity: RARITY.COMMON, tags: [TAGS.STUN], warbond: 'force_of_law' },
  { id: 'g_urchin', name: 'G-109 Urchin', type: TYPE.GRENADE, rarity: RARITY.COMMON, tags: [], warbond: 'force_of_law' },
  { id: 'b_stun_pods', name: 'Stun Pods', type: TYPE.BOOSTER, rarity: RARITY.RARE, tags: [TAGS.STUN], warbond: 'force_of_law' },
  ...
  { id: 'st_deescalator', name: 'GL-52 De-Escalator', type: TYPE.STRATAGEM, rarity: RARITY.RARE, tags: [TAGS.SUPPORT_WEAPON], warbond: 'force_of_law' },
  { id: 'st_bp_k9', name: 'AX/ARC-3 "Guard Dog" K-9', type: TYPE.STRATAGEM, rarity: RARITY.RARE, tags: [TAGS.BACKPACK], warbond: 'force_of_law' },
];
...
export const CONTROL_GROUP_ITEMS = [
  ...
  { id: 'st_bp_warp', name: 'LIFT-182 Warp Pack', type: TYPE.STRATAGEM, rarity: RARITY.LEGENDARY, tags: [TAGS.BACKPACK], warbond: 'control_group' },
];
...
export const DUST_DEVILS_ITEMS = [
  { id: 'p_coyote', name: 'AR-2 Coyote', type: TYPE.PRIMARY, rarity: RARITY.LEGENDARY, tags: [TAGS.FIRE], warbond: 'dust_devils' },
  { id: 'g_pineapple', name: 'G-7 Pineapple', type: TYPE.GRENADE, rarity: RARITY.UNCOMMON, tags: [TAGS.EXPLOSIVE], warbond: 'dust_devils' },
  { id: 'a_ds42', name: 'DS-42 Federation\'s Blade', type: TYPE.ARMOR, rarity: RARITY.RARE, tags: [], warbond: 'dust_devils', passive: ARMOR_PASSIVE.DESERT_STORMER, armorClass: ARMOR_CLASS.HEAVY },
  { id: 'a_ds191', name: 'DS-191 Scorpion', type: TYPE.ARMOR, rarity: RARITY.RARE, tags: [], warbond: 'dust_devils', passive: ARMOR_PASSIVE.DESERT_STORMER, armorClass: ARMOR_CLASS.MEDIUM },
  { id: 'st_speargun', name: 'S-11 Speargun', type: TYPE.STRATAGEM, rarity: RARITY.RARE, tags: [TAGS.SUPPORT_WEAPON], warbond: 'dust_devils' },
  ...
  { id: 'st_solo_silo', name: 'MS-11 Solo Silo', type: TYPE.STRATAGEM, rarity: RARITY.LEGENDARY, tags: [TAGS.SUPPORT_WEAPON], warbond: 'dust_devils' },
];
...
export const PYTHON_COMMANDOS_ITEMS = [
  { id: 'p_onetwo', name: 'AR/GL-21 One-Two', type: TYPE.PRIMARY, rarity: RARITY.UNCOMMON, tags: [TAGS.EXPLOSIVE], warbond: 'python_commandos' },
  ...
  { id: 'st_bp_hotdog', name: 'AX/FLAM-75 "Guard Dog" Hot Dog', type: TYPE.STRATAGEM, rarity: RARITY.RARE, tags: [TAGS.BACKPACK, TAGS.FIRE], warbond: 'python_commandos' },
...
export const OBEDIENT_DEMOCRACY_SUPPORT_TROOPERS_ITEMS = [
  ...
  { id: 'p_m7s', name: 'M7S SMG', type: TYPE.PRIMARY, rarity: RARITY.COMMON, tags: [], warbond: 'obedient_democracy_support_troopers' },
  { id: 'p_m90a', name: 'M90A Shotgun', type: TYPE.PRIMARY, rarity: RARITY.UNCOMMON, tags: [], warbond: 'obedient_democracy_support_troopers' },
  { id: 's_m6c', name: 'M6C/SOCOM Pistol', type: TYPE.SECONDARY, rarity: RARITY.COMMON, tags: [], warbond: 'obedient_democracy_support_troopers' },
...
export const RIGHTEOUS_REVENANTS_ITEMS = [
  { id: 'p_sta52', name: 'StA-52 Assault Rifle', type: TYPE.PRIMARY, rarity: RARITY.UNCOMMON, tags: [], warbond: 'righteous_revenants' },
  { id: 'p_plas39', name: 'PLAS-39 Accelerator Rifle', type: TYPE.PRIMARY, rarity: RARITY.UNCOMMON, tags: [], warbond: 'righteous_revenants' },
  { id: 'p_sta11', name: 'StA-11 SMG', type: TYPE.PRIMARY, rarity: RARITY.COMMON, tags: [], warbond: 'righteous_revenants' },
...
export const PREMIUM_EDITION_ITEMS = [
  { id: 'p_knight', name: 'MP-98 Knight', type: TYPE.PRIMARY, rarity: RARITY.RARE, tags: [], warbond: 'premium_edition' },
...
export const SUPERSTORE_ITEMS = [
  // PRIMARY WEAPONS
  { id: 'p_double_freedom', name: 'DBS-2 Double Freedom', type: TYPE.PRIMARY, rarity: RARITY.RARE, tags: [], superstore: true },
  
  // SECONDARY WEAPONS
  { id: 's_stun_baton', name: 'CQC-30 Stun Baton', type: TYPE.SECONDARY, rarity: RARITY.COMMON, tags: [TAGS.STUN], superstore: true },
  { id: 's_combat_hatchet', name: 'CQC-5 Combat Hatchet', type: TYPE.SECONDARY, rarity: RARITY.UNCOMMON, tags: [], superstore: true },
  ...
  // Armor - Light
  { id: 'a_sc37', name: 'SC-37 Legionnaire', type: TYPE.ARMOR, rarity: RARITY.UNCOMMON, tags: [], superstore: true, passive: ARMOR_PASSIVE.SERVO_ASSISTED, armorClass: ARMOR_CLASS.LIGHT },
  ...
  { id: 'a_fs38', name: 'FS-38 Eradicator', type: TYPE.ARMOR, rarity: RARITY.COMMON, tags: [TAGS.DEFENSIVE], superstore: true, passive: ARMOR_PASSIVE.FORTIFIED, armorClass: ARMOR_CLASS.LIGHT },
  ...
  { id: 'a_ds10', name: 'DS-10 Big Game Hunter', type: TYPE.ARMOR, rarity: RARITY.RARE, tags: [], superstore: true, passive: ARMOR_PASSIVE.DESERT_STORMER, armorClass: ARMOR_CLASS.LIGHT },
  ...
  { id: 'a_ce67', name: 'CE-67 Titan', type: TYPE.ARMOR, rarity: RARITY.COMMON, tags: [], superstore: true, passive: ARMOR_PASSIVE.ENGINEERING_KIT, armorClass: ARMOR_CLASS.LIGHT },
  { id: 'a_fs37', name: 'FS-37 Ravager', type: TYPE.ARMOR, rarity: RARITY.COMMON, tags: [], superstore: true, passive: ARMOR_PASSIVE.ENGINEERING_KIT, armorClass: ARMOR_CLASS.LIGHT },
  ...
  // Armor - Medium
  { id: 'a_sc15', name: 'SC-15 Drone Master', type: TYPE.ARMOR, rarity: RARITY.COMMON, tags: [], superstore: true, passive: ARMOR_PASSIVE.ENGINEERING_KIT, armorClass: ARMOR_CLASS.MEDIUM },
  { id: 'a_b24', name: 'B-24 Enforcer', type: TYPE.ARMOR, rarity: RARITY.COMMON, tags: [TAGS.DEFENSIVE], superstore: true, passive: ARMOR_PASSIVE.FORTIFIED, armorClass: ARMOR_CLASS.MEDIUM },
  { id: 'a_ce81', name: 'CE-81 Juggernaut', type: TYPE.ARMOR, rarity: RARITY.COMMON, tags: [], superstore: true, passive: ARMOR_PASSIVE.ENGINEERING_KIT, armorClass: ARMOR_CLASS.MEDIUM },
  { id: 'a_fs34', name: 'FS-34 Exterminator', type: TYPE.ARMOR, rarity: RARITY.COMMON, tags: [TAGS.DEFENSIVE], superstore: true, passive: ARMOR_PASSIVE.FORTIFIED, armorClass: ARMOR_CLASS.MEDIUM },
  ...
  { id: 'a_cw9', name: 'CW-9 White Wolf', type: TYPE.ARMOR, rarity: RARITY.COMMON, tags: [], superstore: true, passive: ARMOR_PASSIVE.EXTRA_PADDING, armorClass: ARMOR_CLASS.MEDIUM },
  { id: 'a_ph56', name: 'PH-56 Jaguar', type: TYPE.ARMOR, rarity: RARITY.RARE, tags: [], superstore: true, passive: ARMOR_PASSIVE.PEAK_PHYSIQUE, armorClass: ARMOR_CLASS.MEDIUM },
  { id: 'a_i92', name: 'I-92 Fire Fighter', type: TYPE.ARMOR, rarity: RARITY.LEGENDARY, tags: [TAGS.FIRE], superstore: true, passive: ARMOR_PASSIVE.INFLAMMABLE, armorClass: ARMOR_CLASS.MEDIUM },
  { id: 'a_af91', name: 'AF-91 Field Chemist', type: TYPE.ARMOR, rarity: RARITY.RARE, tags: [], superstore: true, passive: ARMOR_PASSIVE.ADVANCED_FILTRATION, armorClass: ARMOR_CLASS.MEDIUM },
  { id: 'a_uf84', name: 'UF-84 Doubt Killer', type: TYPE.ARMOR, rarity: RARITY.RARE, tags: [], superstore: true, passive: ARMOR_PASSIVE.UNFLINCHING, armorClass: ARMOR_CLASS.MEDIUM },
  ...
  // Armor - Heavy
  { id: 'a_b27', name: 'B-27 Fortified Commando', type: TYPE.ARMOR, rarity: RARITY.COMMON, tags: [TAGS.DEFENSIVE], superstore: true, passive: ARMOR_PASSIVE.EXTRA_PADDING, armorClass: ARMOR_CLASS.HEAVY },
  ...
  { id: 'a_fs11', name: 'FS-11 Executioner', type: TYPE.ARMOR, rarity: RARITY.COMMON, tags: [TAGS.DEFENSIVE], superstore: true, passive: ARMOR_PASSIVE.FORTIFIED, armorClass: ARMOR_CLASS.HEAVY },
  ...
  { id: 'a_ce64', name: 'CE-64 Grenadier', type: TYPE.ARMOR, rarity: RARITY.COMMON, tags: [TAGS.EXPLOSIVE], superstore: true, passive: ARMOR_PASSIVE.ENGINEERING_KIT, armorClass: ARMOR_CLASS.HEAVY },
  { id: 'a_ce101', name: 'CE-101 Guerilla Gorilla', type: TYPE.ARMOR, rarity: RARITY.COMMON, tags: [], superstore: true, passive: ARMOR_PASSIVE.ENGINEERING_KIT, armorClass: ARMOR_CLASS.HEAVY },
  { id: 'a_i44', name: 'I-44 Salamander', type: TYPE.ARMOR, rarity: RARITY.LEGENDARY, tags: [TAGS.FIRE], superstore: true, passive: ARMOR_PASSIVE.INFLAMMABLE, armorClass: ARMOR_CLASS.HEAVY },
  { id: 'a_af52', name: 'AF-52 Lockdown', type: TYPE.ARMOR, rarity: RARITY.RARE, tags: [], superstore: true, passive: ARMOR_PASSIVE.ADVANCED_FILTRATION, armorClass: ARMOR_CLASS.HEAVY },
  { id: 'a_sr64', name: 'SR-64 Cinderblock', type: TYPE.ARMOR, rarity: RARITY.LEGENDARY, tags: [], superstore: true, passive: ARMOR_PASSIVE.SIEGE_READY, armorClass: ARMOR_CLASS.HEAVY },
